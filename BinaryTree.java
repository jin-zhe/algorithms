...
// algorithms regarding binary trees
public class BinaryTree {
	...
	public Node getLCA(Node node, int xValue, int yValue){
		...
		// else if left subtree contains only 1 (could be LCM or X or Y)
		if (leftAns != null && rightAns == null) return leftAns;
		
		// else if right subtree contains only 1 (could be LCM or X or Y)
