...
/**
 * Given an array of numbers, return the Kth smallest number in the list (where 1st smallest refers to the smallest item)
 */
public class KthSmallest {
	...
	/**
	 * Gets the item corresponding to the given rank i from the array. O(N) average case where N = end - start
	...
	/**
	 * Randomly selects a pivot and set it to be the first element in array. O(1)
	 * @param arr	the array of interest
	 * @param start	start point of subarray (inclusive)
	 * @param end	end point of subarray (exclusive)
	 */
